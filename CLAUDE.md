...
- **REM-013 (reencuadrar RODI +1,291%):** ya cumplido en `cases/sofi.html` desde su build original (modelado, cost-avoidance no ahorro realizado, sin auditoría externa, metodología a solicitud) — sin cambios. **Queda parcialmente abierto:** falta revisar la prominencia del +1,291% en `index.html` antes de cerrarlo globalmente.
